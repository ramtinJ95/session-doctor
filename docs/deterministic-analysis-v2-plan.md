...
- boundary export stores a private routing envelope only in DuckDB and writes
  deterministic judge-visible packets with predictions and routing identity
  excluded;
...
- audit selection freezes one protocol-level seed and the complete eligible
